...
function maybeInitSelect2() {
  var fields = document.querySelectorAll(".saveyour--select2");
...
function initSelect2(fields) {
  Array.from(fields).forEach(function (select) {
    var config = JSON.parse(select.dataset.saveyour__select2);
...
/******/ });
//# sourceMappingURL=saveyour.js.map